ECCV:
Spatio-temporal Transformer Network for PS-FCN: A Flexible Learning Framework for Photometric Stereo
    Guanying Chen, Kai Han, Kwan-Yee K. Wong 
     
Ask, Acquire, and Attack: Data-free UAP      
Making Deep Heatmaps Robust to Partial Occlusions for Image Inpainting for Irregular Holes Using Partial Convolutions
...
Product Quantization Network for Fast Image  
Hand Pose  
...
Super-Identity Convolutional Neural Network for  
SOD-MTGAN: Small Object Detection via Multi-Task      
HybridNet: Classification and Reconstruction Cooperation for Semi- 
...
Multi-Fiber Networks for  Towards Human-Level  
...
Learning Human-Object Interactions by Graph  
...
Point-to-Point Regression PointNet for  
Fine-grained  
Analyzing Clothing Layer Deformation Statistics of  
...
Fully Motion-Aware Network for  
Learning to Forecast and Refine Residual Motion for Image-to- 
Geometric Constrained Joint Lane  
...
Deep Bilinear Learning for RelocNet: Continuous Metric Learning Relocalisation using Neural Nets
...
ICNet for Real-Time Parallel Feature Pyramid Network for Object Detection
    Seung-Wook Kim, Hyong-Keun Kook, Jee-Young Sun, Mun-Cheon Kang, Sung-Jea Ko 
     
Learn-to-Score: Efficient  
Joint Representation and Truncated Inference Learning for Correlation Filter based  
...
Move Forward and Tell: A Progressive      
...
Learning and  
Flow-Grounded Spatial-Temporal  
...
Learning to Capture Light Fields through a Coded Aperture  
Learning to Reconstruct High-quality  
X2 
End-to-End Learning of Driving Models with Surround-View  
...
A Dataset of Flash and Ambient Illumination Pairs from the Crowd
    Yagiz Aksoy, Changil Kim, Petr Kellnhofer, Sylvain Paris, Mohamed Elgharib, Marc Pollefeys, Wojciech Matusik 
     
ISNN: Impact Sound Neural Network for Audio-Visual Object Classification
    Auston Sterling, Justin Wilson, Sam Lowe, Ming C. Lin 
     
Dependency-aware Attention Control for Unconstrained  
StereoNet: Guided Hierarchical Refinement for Real-Time Edge-Aware Depth  
Compositing-aware Image Search
    Hengshuang Zhao, Xiaohui Shen, Zhe Lin, Kalyan Sunkavalli, Brian Price, Jiaya Jia 
     
Online Multi-Object  Improving Sequential Determinantal Point Processes for  
A Framework for Evaluating 6-DOF Object  Learning to Separate Object Sounds by Watching Unlabeled  Connecting Gaze, Scene, and Attention: Meta- 
Variable Ring Light Imaging: Capturing Transient Subsurface Scattering with An Ordinary  
Deep Domain      
Using LIP to Gloss Over  
Pose-Normalized Image      
Deep Cross-Modal Projection Learning for Image-Text  
...
Learning Shape Priors for Single-View  
...
Learning Data Terms for Non-blind  
Mutual Learning to Adapt for Joint Human        
Orthogonal Deep Features Decomposition for Age-Invariant  
Long-term  
Affinity Derivation and Graph Merge for Instance  
...
DCAN: Dual Channel-wise Alignment Networks for Unsupervised Scene Adaptation
    Zuxuan Wu, Xintong Han, Yen-Liang Lin, Mustafa Gokhan Uzunbas, Tom Goldstein, Ser Nam Lim, Larry S. Davis 
...
Grid 
Weakly-supervised  
Compound Memory Networks for Few-shot  
...
Weakly-supervised  
T2Net: Synthetic-to-Realistic Translation for Solving Single-Image Depth  
Instance-level Human  
TextSnake: A Flexible Representation for Detecting Text of Arbitrary Shapes
    Shangbang Long, Jiaqiang Ruan, Wenjie Zhang, Xin He, Wenhao Wu, Cong Yao 
     
PPF-FoldNet: Unsupervised Learning of Rotation Invariant  
...
SRDA:     Zorah Lahner, Daniel Cremers, Tony Tung 
...
Effective Use of Synthetic Data for Urban Scene  
ActiveStereoNet: End-to-End Self- 
ShapeCodes: Self- 
Unsupervised Domain Adaptation for  
Learning Discriminative  
BSN: Boundary Sensitive Network for Temporal Action Proposal      
...
DDRNet: Depth Map Denoising and Refinement for Consumer Depth  
ELEGANT: Exchanging Latent Encodings with GAN for Transferring Multiple  
Progressive Structure from Motion
    Alex Locher, Michal Havlena, Luc Van Gool 
     
GAL: Geometric Adversarial Loss for Single-View  
Viewpoint  
...
SaaS: Speed as a  
AutoLoc: Weakly-supervised Temporal Action Localization in Untrimmed  
...
Semi-supervised FusedGAN for Conditional Image      
Practical Black-box Attacks on Deep Neural Networks using Efficient Query Mechanisms
    Arjun Nitin Bhagoji, Warren He, Bo Li, Dawn Song 
     
PersonLab: Person Pose  
...
DYAN: A Dynamical Atoms-Based Network For  
...
Joint Task-Recursive Learning for  
...
Deep Virtual Stereo Odometry: Leveraging Deep Depth HandMap: Robust Hand Pose  
Partial Adversarial Domain Adaptation
    Zhangjie Cao, Lijia Ma, Mingsheng Long, Jianmin Wang 
     
ExFuse: Enhancing Feature Fusion for  
Audio-Visual Event Localization in Unconstrained  
...
How Local is the Local Diversity? Reinforcing Sequential Determinantal Point Processes with Dynamic Ground Sets for       
...
Sampling Algebraic Varieties for Robust  
...
Unsupervised Class-Specific  
VSO: Visual   
Learning Priors for  
The Unmanned Aerial Vehicle Benchmark: Object Detection and  
...
Visual Reasoning with Multi-hop Feature Modulation
    Florian Strub, Mathieu Seurin, Ethan Perez, Harm de Vries, Jeremie Mary, Philippe Preux, Aaron CourvilleOlivier Pietquin 
     
Object Detection in  
Diverse Conditional Image      
Extreme Network Compression via Filter Group Approximation
    Bo Peng, Wenming Tan, Zheyang Li, Shun Zhang, Di Xie, Shiliang Pu 
     
Efficient Sliding Window Computation for NN-Based Template  
...
Deep     Pau Rodriguez, Josep M. Gonfaus, Guillem Cucurull, F. XavierRoca, Jordi Gonzalez 
...
SRFeat: Single Image Super-Resolution with Feature Discrimination
    Seong-Jin Park, Hyeongseok Son, Sunghyun Cho, Ki-Sang Hong, Seungyong Lee 
...
Deep Autoencoder for Combined Human Pose  
...
Occlusion-aware Hand Pose  
Rolling Shutter Pose and Ego-motion  
A Minimal Closed-Form Solution for Multi-Perspective Pose  
Burst Image  
...
Good Line Cutting: towards Accurate Pose  
Composition Loss for Counting, Density Map  ``Factual'' or ``Emotional'': Stylized Image Captioning with Adaptive Learning and Attention
...
Deep Recursive HDRI: Inverse Tone Mapping using      
Deep Discriminative Model for Materials for Masses: SVBRDF Acquisition with a Single Mobile Phone Image
...
GANimation: Anatomically-aware  
Deep Kalman Filtering Network for  
...
Coloring with Words: Guiding Image Colorization Through Text-based Palette      
...
FloorNet: A Unified Framework for Floorplan Reconstruction from   
...
Structure-from-Motion-Aware PatchMatch for Adaptive Optical Flow  
...
Accelerating Dynamic Programs via Nested Benders Decomposition with Application to Multi-Person Pose  
OmniDepth: Dense Depth  
...
The Mutex Watershed: Efficient, Parameter-Free Image Partitioning
    Steffen Wolf, Constantin Pape, Alberto Bailoni, Nasim Rahaman, Anna Kreshuk, Ullrich Kothe, FredA. Hamprecht 
...
Occlusions, Motion and Depth Boundaries with a Learning to  
Diverse and Coherent Paragraph      
...
Fully-Convolutional Point Networks for Large-Scale Point Clouds
    Dario Rethage, Johanna Wald, Jurgen Sturm, Nassir Navab, Federico Tombari 
...
SwapNet: Garment Transfer in Single View Images
    Amit Raj, Patsorn Sangkloy, Huiwen Chang, Jingwan Lu, Duygu Ceylan, James Hays 
     
Learning SO(3) Equivariant Representations with Spherical CNNs
    Carlos Esteves, Christine Allen-Blanchette, Ameesh Makadia, Kostas Daniilidis 
     
Multiple-gaze geometry: Inferring novel  
...
Ensemble Diffusion for  
FoveaNet: Perspective-Aware Urban Scene  
...
BodyFusion: Real-Time Capture of Human Motion and Surface Geometry Using a Single Depth  
...
Corner-Based Geometric Calibration of Multi-Focus Plenoptic  
Focal 
...
Transitive Invariance for Self- 
Weakly  
...
WeText: Scene Text Detection Under Weak  
...
Modelling the Scene Dependent Imaging in  
Weakly   
...
ScaleNet: Guiding Object Proposal  
VQS: Linking  Soft Proposal Networks for Weakly  
...
Learned Watershed: End-To-End Learning of Seeded  
Curriculum Domain Adaptation for 
Scale-Adaptive Convolutions for Scene  
...
Joint Bi-Layer Optimization for Single-Image Rain Streak  
...
Introspective Neural Networks for  
...
Temporal Action Detection With Structured  
...
A Tiancheng Sun, Yifan Peng, Wolfgang Heidrich
 
High-Quality Correspondence and   
...
Recurrent Topic-Transition GAN for Visual Paragraph  
...
SGN: Sequential Grouping Networks for Instance  
...
FCN-rLSTM: Deep Spatio-Temporal Neural Networks for Vehicle Counting in City  
Fast 
...
Parameter-Free Lens Distortion Calibration of Central  
...
PPR-FCN: Weakly  
Higher-Order Minimum Cost Lifted Multicuts for Motion  
...
Summarization and Classification of Wearable  
...
Deep Jingyu Liu, Liang Wang, Ming-Hsuan Yang
 
RDFNet:  Yue Wu, Prem Natarajan
...
End-To-End 
Active Decision Boundary Annotation With Deep  
...
Deltille Grids for Geometric  
A Lightweight Single-  
...
Finding Tiny 
Learning 
PairedCycleGAN: Asymmetric Style Transfer for Applying and  
...
Disentangled Person Image  
Super-FAN: Integrated Chenyang Si, Wei Wang, Liang Wang, Tieniu Tan
...
Depth and Transient Imaging With Compressive SPAD Array  
...
Learned Shape-Tailored Descriptors for  
...
A Seong Jae Hwang, Sathya N. Ravi, Zirui Tao, Hyunwoo J. Kim, Maxwell D. Collins, Vikas Singh
...
AttnGAN: Fine-Grained Text to Image  
Adversarial Complementary Learning for Weakly  
Conditional  
...
Improving Landmark Localization With Semi- 
...
A Perceptual Measure for Deep Single Image  
...
PlaneNet: Piece-Wise Planar Reconstruction From a Single  
...
Progressively Complementarity-Aware Fusion Network for  
...
Coupled End-to-End Transfer Learning With  
...
PointNetVLAD: Deep Point Cloud Based  
...
Texture Mapping for 
Learning Less Is More - 6D  Pyojin Kim, Brian Coltin, H. Jin Kim
...
Rolling Shutter and Radial Distortion Are Features for High Frame Rate Multi- Learning Attentions: Residual Attentional Siamese Network for High Performance Online Visual 
SINT++: Robust Visual 
High-Speed 
...
Multimodal Visual Concept Learning With Weakly  
...
Optimizing Filter Size in Convolutional Neural Networks for  
V2V-PoseNet: Voxel-to-Voxel Houjing Huang, Dangwei Li, Zhang Zhang, Xiaotang Chen, Kaiqi Huang
 
Classifier Learning With Prior Probabilities for  
4DFAB: A Large Scale 4D Database for  
Seeing Small 
2D/
Dense  
...
Referring Image  
Two Can Play This Game: Visual Dialog With Discriminative Question A Deeper Look at Power Normalizations
...
Improving Color Reproduction Accuracy on  
...
Weakly- Takuhiro Kaneko, Kaoru Hiramatsu, Kunio Kashino
...
Weakly-  
Bilateral Ordinal Relevance Multi-Instance Regression for Yang Wang, Minh Hoai
...
Every Smile Is Unique: Landmark-Guided Diverse Smile  
...
Differential Attention for Visual Question Learning From  
...
SketchMate: Deep Hashing for Million-Scale Human Sketch  
...
Single Image Dehazing via Conditional  
